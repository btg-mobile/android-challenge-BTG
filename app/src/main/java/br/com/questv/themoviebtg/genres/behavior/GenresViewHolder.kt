...
import br.com.questv.themoviebtg.movies.behavior.MoviesAdapter
import br.com.questv.themoviebtg.movies.behavior.MoviesPresenter
import br.com.questv.themoviebtg.movies.behavior.MoviesView
import br.com.questv.themoviebtg.movies.model.MovieModel

class GenresViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), MoviesView {
    ...
    private val moviePresenter = MoviesPresenter(this)
    ...
    override fun initRecyclerView(movieModelList: List<MovieModel>) {
        this.moviesRecyclerView.adapter = MoviesAdapter(movieModelList)
    }
