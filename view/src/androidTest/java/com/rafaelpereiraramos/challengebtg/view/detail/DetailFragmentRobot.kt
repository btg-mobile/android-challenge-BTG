...
internal fun assert(func: DetailFragmentAssert.() -> Unit) = DetailFragmentAssert().apply { func() }
...
class DetailFragmentArrange {
    ...
    fun launch() {
        launchFragmentInContainer<DetailFragment>(fragmentArgs = Bundle(), themeResId = R.style.AppTheme)
    }
}
